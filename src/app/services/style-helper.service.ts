...
export class StyleHelperService {
  public DOCUMENT: InjectionToken<Document> = new InjectionToken<Document>('Document')
  ...
  public addColorsToDocument(bgColor: string): void {
    const fontColor = this.getContrast(bgColor)
