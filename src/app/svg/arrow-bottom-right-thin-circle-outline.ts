export const appArrowBottomRightThinCircleOutlineIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 20.03c-4.41 0-8.03-3.62-8.03-8.03 0-4.41 3.62-8.03 8.03-8.03 4.41 0 8.03 3.62 8.03 8.03 0 4.41-3.62 8.03-8.03 8.03M12 22c5.54 0 10-4.46 10-10S17.54 2 12 2 2 6.46 2 12s4.46 10 10 10m1.88-9.53L16 10.36V16h-5.64l2.11-2.12L7.5 8.9l1.4-1.4"/></svg>`,
